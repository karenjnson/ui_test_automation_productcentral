...
public abstract class CopyOfUITestBase {

	private static final Log LOG = LogFactory.getLog(CopyOfUITestBase.class);
	...
	@Parameters({"env", "gridProviders", "batchName"})
	public void beforeSuite(String env, @Optional(DEFAULT_GRID_PROVIDERS) String gridProviders, @Optional String batchName) throws IOException {
